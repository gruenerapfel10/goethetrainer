...
import { MatrixRainBackground } from "@/components/offer/matrix-rain-background"
...
import { AnimatedSection } from "@/components/offer/animated-section"
          ...
          <div className="container mx-auto px-4 md:px-6">
            <AnimatedSection className="grid grid-cols-1 items-start gap-8 lg:grid-cols-2 lg:gap-12">
              ...
              <PlanCard
                ...
                price="$99"
                period="/PER YEAR"
                description="Master the journey. Unlock the full power of Goethe for unlimited applications and elite insights."
