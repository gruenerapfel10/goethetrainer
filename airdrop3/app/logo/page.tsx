    ...
    <main className="flex min-h-screen w-full flex-col items-center justify-center bg-gray-100 p-4 sm:p-8">
      <div className="w-full max-w-4xl rounded-lg bg-white p-8 shadow-md">
        ...
        <div className="space-y-12">
          <div>
            <h2 className="mb-6 text-center text-2xl font-semibold text-gray-800">Square Icons</h2>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <LogoGenerator
                ...
                fileNamePrefix="mua-logo-icon-blue-bg"
              />
              <LogoGenerator
                title="Blue on Transparent"
                logoComponent={<MuaLogoVertical className="h-24 w-auto text-blue-600" />}
                previewBgColor="#ffffff"
                fileNamePrefix="mua-logo-icon-transparent-bg"
              />
            </div>
          </div>
          <div>
            <h2 className="mb-6 text-center text-2xl font-semibold text-gray-800">Horizontal Banners</h2>
            <div className="grid grid-cols-1 gap-8">
              <LogoGenerator
                title="Standard Banner (White on Blue)"
                ...
                exportWidth={300}
                exportHeight={100}
                previewClassName="w-72 h-24"
              />
              <LogoGenerator
                title="Standard Banner (Blue on Transparent)"
              ...
              />
              <LogoGenerator
                title="Custom Banner - 223x48 (White on Blue)"
                logoComponent={<MuaLogo className="h-8 w-auto text-white" />}
                previewBgColor="#2c55ff"
                exportBgColor="#2c55ff"
                fileNamePrefix="mua-logo-banner-223x48-blue-bg"
                exportWidth={223}
                exportHeight={48}
                previewClassName="w-56 h-12"
              />
              <LogoGenerator
                title="Custom Banner - 223x48 (Blue on Transparent)"
                logoComponent={<MuaLogo className="h-8 w-auto text-blue-600" />}
                previewBgColor="#ffffff"
                fileNamePrefix="mua-logo-banner-223x48-transparent-bg"
                exportWidth={223}
                exportHeight={48}
                previewClassName="w-56 h-12"
              />
