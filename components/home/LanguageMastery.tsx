...
export default function LanguageMastery() {
  ...
  return (
    <section className="w-full bg-black py-20 md:py-32" data-section="language-mastery">
      <div className="px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-20 md:space-y-32">
          ...
          {tracks.map((track, index) => (
            <div key={index} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              {track.imagePosition === 'left' && (
                <div className="h-80 md:h-96 bg-white/10 rounded-lg flex items-center justify-center order-2 lg:order-1">
              ...
              {track.imagePosition === 'right' && (
                <div className="h-80 md:h-96 bg-white/10 rounded-lg flex items-center justify-center">
                  <p className="text-white/50">Illustration</p>
                </div>
              )}
            </div>
          ...
          <div className="text-center py-12">
            <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white max-w-3xl mx-auto">
