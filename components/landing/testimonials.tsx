...
const testimonials = [
  {
    quote:
      "MUA made the impossible feel simple. I applied to universities in three different countries from one place. It's a game-changer.",
    name: "Priya Sharma",
  ...
  {
    quote:
      "As a first-generation student, the global application process was daunting. MUA provided the clarity and tools I needed to succeed.",
