...
const FeatureCell = ({ value }: { value: boolean | string }) => {
  if (typeof value === "boolean") {
    return value ? <Check className="h-6 w-6 text-blue-500" /> : <X className="h-6 w-6 text-zinc-600" />
  }
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px] border-collapse text-left">
            <thead>
              <tr>
                <th className="w-1/2 p-4 text-sm font-semibold uppercase text-zinc-400">Feature</th>
                <th className="w-1/4 p-4 text-center text-sm font-semibold uppercase text-zinc-400">Explorer</th>
                <th className="w-1/4 p-4 text-center text-sm font-semibold uppercase text-zinc-400">Navigator</th>
              </tr>
            </thead>
            <tbody>
