...
export function SidebarSearch({ value, onChange, resultCount, onOpenModal }: SidebarSearchProps) {
  ...
  // Show collapsed search button only when sidebar is truly collapsed (desktop only)
  const isMobile = width < 768;
  if (state === 'collapsed' && width >= 1024) {
    return (
      <motion.div
        ...
        >
          ...
          <div
            className={cn(
              ...
              "bg-gradient-to-r from-orange-500/20 via-primary/20 to-orange-500/20",
