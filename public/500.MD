...
```json
"academic_requirements": {
  "class_12_percentage": "string",   // Class 12 percentage requirements
  "required_subjects": ["string"],   // Mandatory subjects (Physics, Chemistry, Math)
  "standardized_tests": ["string"],  // Required tests (SAT, ACT for US universities)
  "sat_scores": {
    "average": "number",             // Average SAT score
    "math": "string",                // Math section score range
    "evidence_based_reading": "string" // ERW section score range
  },
  "act_scores": {
    "average": "number",             // Average ACT score
    "range": "string"                // Score range
  },
  "subject_tests": "string",         // Subject test requirements
  "ap_courses": "string",            // AP course recommendations
  "extracurriculars": "string"      // Extracurricular expectations
}
```
